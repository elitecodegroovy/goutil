...
```bash
go get github.com/goutil/termtables
```

## Go Style Documentation

[http://godoc.org/github.com/goutil/termtables](http://godoc.org/github.com/goutil/termtables)
